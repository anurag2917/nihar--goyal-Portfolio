    ...
    >
      ...
      <div className="flex justify-between items-start mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h4 className="font-bold text-[#0F0F0F] text-sm">{name}</h4>
        ...
        {badgeType === 'quote' && (
          <div className="text-[#ff5a00] text-3xl font-serif leading-none mt-[-5px]">❞</div>
        )}

        {badgeType === 'waveform' && (
          <div className="flex items-end gap-[2px] h-5 opacity-40">
            {[3, 6, 4, 8, 5].map((h, i) => (
              <div
                key={i}
      ...
      <div className="flex-grow flex flex-col justify-center mb-6">
        {hasAudioStrip && (
          <div className="bg-gray-50 rounded-full h-10 flex items-center px-3 relative mb-4">
        ...
        {hasVideoThumb && (
          <div className="w-full h-[120px] bg-[#1a1a1a] rounded-xl flex items-center justify-center relative overflow-hidden mb-4">
